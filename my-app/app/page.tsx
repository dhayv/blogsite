  ...
  return (
    <div className=" max-w-xl mx-auto w-full">
      ...
      <main className="flex flex-col gap-4 row-start-2 items-center sm:items-start">
        ...
        <p>This blog is orchestrated through Terraform, powered by AWS (S3, CloudFront, Route53, ACM), automated using GitHub Actions, and brought to life with Next.js. Every component represents another challenge conquered, another level mastered.</p>
