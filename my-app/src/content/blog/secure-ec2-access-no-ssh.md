---
title: "How to Connect to EC2 Without SSH Using SSM Session Manager"
date: "01-08-2025"
author: "David Hyppolite"
excerpt: "Replace SSH keys and bastion hosts with AWS SSM Session Manager for secure, auditable EC2 access using IAM roles and CloudWatch logging."
...
## Why SSH Key Management Is a Problem at Scale
...
## Benefits of SSM Session Manager Over SSH
...
### SSM Session Manager Security and Compliance Features
...
## Setting Up IAM Roles for SSM Access

### What Is an IAM Instance Profile for EC2
...
### Launch an EC2 Instance Without SSH Key Pair
...
### Summary: EC2 Access Without SSH Using AWS SSM
